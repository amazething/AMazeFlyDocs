...
latex_documents = [
    (master_doc, 'AMazeFlyDocs.tex', 'AMazeFlyDocs Documentation',
     'AMaze', 'manual'),
]
...
man_pages = [
    (master_doc, 'amazeflydocs', 'AMazeFlyDocs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AMazeFlyDocs', 'AMazeFlyDocs Documentation',
     author, 'AMazeFlyDocs', 'One line description of project.',
     'Miscellaneous'),
]
